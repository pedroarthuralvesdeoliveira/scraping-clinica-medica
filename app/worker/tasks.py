...
from app.scraper import appointment_scheduler, appointment_canceller, availability_checker 
...
def schedule_appointment_task(
    ...
    result = appointment_scheduler.schedule_appointment(medico, data_desejada, paciente_info, horario_desejado, tipo_atendimento)
...
def cancel_appointment_task(medico, data_desejada, horario_desejado, nome_paciente):
    ...
    result = appointment_canceller.cancel_appointment(medico, data_desejada, horario_desejado, nome_paciente)
...
def verify_doctors_calendar_task(medico: str, data_desejada: str | None = None, horario_desejado: str | None = None, horario_inicial: str | None = "07:00", horario_final: str | None = "19:30"):
    ...
    result = availability_checker.verify_doctors_calendar(medico, data_desejada, horario_desejado, horario_inicial, horario_final)
