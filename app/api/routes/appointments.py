...
from ..schemas.common import CancelPayload, SchedulePayload, VerifyPayload
from ...worker.celery_app import celery

router = APIRouter()

@router.post("/schedule", dependencies=[Depends(get_api_key)], summary="Agendar consulta")
...
@router.post("/cancel", dependencies=[Depends(get_api_key)], summary="Cancelar consulta")
...
@router.get("/availability", dependencies=[Depends(get_api_key)], summary="Verificar disponibilidade de consulta")
