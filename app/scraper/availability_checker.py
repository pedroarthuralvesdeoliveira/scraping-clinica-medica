...
class AvailabilityChecker(Browser):
    ...
    def _verify_availability(self, data_desejada: str | None = None, horario_desejado: str | None = None, horario_inicial: str | None = None, horario_final: str | None = None):
        if data_desejada and horario_desejado:
            ...
            if len(elementos_filhos) > 0:
                ...
                print(f"O horário {horario_desejado}, formatado como {horario_id}, do dia {data_desejada} está DISPONÍVEL para o profissional selecionado.")
    ...
    def verify_doctors_calendar(
        ...
        try:
            ...
            result = self._verify_availability(data_desejada, horario_desejado, horario_inicial, horario_final)
